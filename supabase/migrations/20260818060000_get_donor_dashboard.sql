    ...
    WITH donor_campaign_data AS (
        SELECT 
            ...
            CASE
                ...
                WHEN d.paid = false AND d.donor_status = 'PLEDGED' AND c.status = 'FINALIZED' THEN 'NEED_PAYMENT'
                WHEN d.paid = false AND d.donor_status = 'PLEDGED' AND c.status <> 'FINALIZED' THEN 'WAITING_FINALIZATION'
